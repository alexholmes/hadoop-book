  ...
  protected static class PasswdRecordWriter<K, V>
    ...
    static {
      try {
        newline = "\n".getBytes(utf8);
        separator =
        com.manning.hip.ch2.PasswdInputFormat.PasswdRecordReader.
     ...
     */
    private void writeObject(com.manning.hip.ch2.Passwd o) throws IOException {
    ...
    public synchronized void write(K key, V value)
      ...
      if(!nullKey && key instanceof com.manning.hip.ch2.Passwd) {
        writeObject((com.manning.hip.ch2.Passwd) key);
        out.write(newline);
      } else if(!nullValue && value instanceof com.manning.hip.ch2.Passwd) {

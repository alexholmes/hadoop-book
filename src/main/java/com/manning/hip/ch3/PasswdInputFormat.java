 ...
 * are {@link com.manning.hip.ch2.Passwd} objects.
 */
public class PasswdInputFormat extends
    FileInputFormat<LongWritable, com.manning.hip.ch2.Passwd> {

  @Override
  public RecordReader<LongWritable, com.manning.hip.ch2.Passwd>
  ...
  public static class PasswdRecordReader
      extends RecordReader<LongWritable, com.manning.hip.ch2.Passwd> {
    public final static String PASSWD_LINE_SEPARATOR = ":";
    private LineRecordReader reader = new LineRecordReader();
    private com.manning.hip.ch2.Passwd value;
    ...
    private void parseLine() {
      ...
      value = new com.manning.hip.ch2.Passwd(
    ...
    @Override
    public com.manning.hip.ch2.Passwd getCurrentValue()
        throws IOException, InterruptedException {
      return value;
    }
